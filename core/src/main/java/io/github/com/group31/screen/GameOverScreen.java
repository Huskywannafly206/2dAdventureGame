...
public class GameOverScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        this.stage.addActor(new GameOverView(stage, skin, new GameOverViewModel(game)));

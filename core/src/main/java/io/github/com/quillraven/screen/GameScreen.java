...
import io.github.com.quillraven.save.SaveData;
import io.github.com.quillraven.save.SaveService;
import io.github.com.quillraven.system.AiSystem;
...
import io.github.com.quillraven.system.DeadSystem;
    ...
    public void show() {
        ...
        this.viewModel.onPropertyChange(GameViewModel.PLAYER_DEAD, Boolean.class, isDead -> {
            if (Boolean.TRUE.equals(isDead)) {
                this.game.setScreen(GameOverScreen.class);
            }
        });
    ...
    public void hide() {
        ...
        if (saveService != null) {
            ...
            if (players.size() > 0) {
                ...
                Life life = Life.MAPPER.get(player);
                data.playerHp = life != null ? life.getLife() : 0f;

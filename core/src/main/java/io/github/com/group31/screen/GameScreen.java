...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(GdxGame game) {
        ...
        this.engine.addSystem(new io.github.com.group31.system.InteractionSystem(this.viewModel, io.github.com.group31.quest.QuestManager.INSTANCE, this.tiledAshleyConfigurator, game.getAssetService()));
